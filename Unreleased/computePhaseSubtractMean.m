function [theta, ys] = computePhaseFixMean(Xa,Xb,piezoSign,varargin)
...
%   segmentValidation. Its mean is subtracted from ys to center it around
%   zero in order to avoid problems with finding peaks. 
...
for iSeg = 1:nSegments
    ...
    %peakOptsMax.MinPeakHeight = 0.05 * max(y);
    %peakOptsMin.MinPeakHeight = 0.05 * max(-y);

...
% PLOTWAVEFORMS Plots the waveforms given in the columns of DATA on top of
% each other. Before plotting, the mean value of each waveform is
% substracted from it.
%   
%   PLOTWAVEFORMS(data) Plots the waveforms on top of each other.
%   
%   PLOTWAVEFORMS(data,filename) Plots the waveforms in data and outputs

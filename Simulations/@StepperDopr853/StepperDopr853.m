classdef StepperDopr853 < handle
    ...
    methods
        function obj = StepperDopr853(y, dydx, x, atol, rtol, dense)
            obj.y = y;
            obj.dydx = dydx;
            obj.x = x;
            obj.atol = atol;
        ...
        function step(obj, htry, derivs)
            h = htry;
            while 1
                dy(obj,h,derivs);
                err = error(obj, h);
                [succ, h] = obj.con.success(err,h);
                if (succ); break; end;
                assert((abs(h) >= abs(obj.x)*obj.EPS),...
                    'Stepsize underflow in StepperDopr853');
            end
            dydxnew = derivs(obj.x+h,obj.yout);
            if (obj.dense); prepareDense(h,dydxnew,derivs); end;
            obj.dydx = dydxnew;
            obj.y = obj.yout;
            obj.xold = obj.x;
            obj.hdid = h;
            obj.x = obj.x + obj.hdid;
            obj.hnext = obj.con.hnext;
        end
        
        function dy(obj, h, derivs)
            ytemp = obj.y + h*obj.a21*obj.dydx;
            k2 = derivs(obj.x+obj.c2*h,ytemp);
            ytemp = obj.y + h*(obj.a31*obj.dydx+obj.a32*k2);
            k3 = derivs(obj.x+obj.c3*h,ytemp);
            ytemp = obj.y + h*(obj.a41*obj.dydx+obj.a43*k3);
            k4 = derivs(obj.x+obj.c4*h,ytemp);
            ytemp = obj.y + h*(obj.a51*obj.dydx+obj.a53*k3+obj.a54*k4);
            k5 = derivs(obj.x+obj.c5*h,ytemp);
            ytemp = obj.y + h*(obj.a61*obj.dydx+obj.a64*k4+obj.a65*k5);
            k6 = derivs(obj.x+obj.c6*h,ytemp);
            ytemp = obj.y + h*(obj.a71*obj.dydx+obj.a74*k4+...
                obj.a75*k5+obj.a76*k6);
            k7 = derivs(obj.x+obj.c7*h,ytemp);
            ytemp = obj.y + h*(obj.a81*obj.dydx+obj.a84*k4+...
                obj.a85*k5+obj.a86*k6+obj.a87*k7);
            k8 = derivs(obj.x+obj.c8*h,ytemp);
            ytemp = obj.y + h*(obj.a91*obj.dydx+obj.a94*k4+...
                obj.a95*k5+obj.a96*k6+obj.a97*k7+obj.a98*k8);
            k9 = derivs(obj.x+obj.c9*h,ytemp);
            ytemp = obj.y + h*(obj.a101*obj.dydx+obj.a104*k4+...
                obj.a105*k5+obj.a106*k6+obj.a107*k7+...
                obj.a108*k8+obj.a109*k9);
            k10 = derivs(obj.x+obj.c10*h,ytemp);
            ytemp = obj.y + h*(obj.a111*obj.dydx+obj.a114*k4+obj.a115*k5+...
                obj.a116*k6+obj.a117*k7+obj.a118*k8+obj.a119*k9+...
                obj.a1110*k10);
            k2 = derivs(obj.x+obj.c11*h,ytemp);
            xph = obj.x+h;
            ytemp = obj.y + h*(obj.a121*obj.dydx+obj.a124*k4+obj.a125*k5+...
                obj.a126*k6+obj.a127*k7+obj.a128*k8+obj.a129*k9+...
                obj.a1210*k10+obj.a1211*k2);
            k3 = derivs(xph,ytemp);
            k4 = obj.b1*obj.dydx+obj.b6*k6+obj.b7*k7+obj.b8*k8+obj.b9*k9+...
                obj.b10*k10+obj.b11*k2+obj.b12*k3;
            obj.yout = obj.y + h*k4;
            
            % Two error estimators
            obj.yerr = k4-obj.bhh1*obj.dydx-obj.bhh2*k9-obj.bhh3*k3;
            obj.yerr2 = obj.er1*obj.dydx+obj.er6*k6+obj.er7*k7+...
                obj.er8*k8+obj.er9*k9+obj.er10*k10+obj.er11*k2+obj.er12*k3;
        end
        
        function [error] = error(obj, h)
            sk=obj.atol+obj.rtol*max(abs(obj.y),abs(obj.yout));
            err2 = sum((obj.yerr./sk).^2);
            err = sum((obj.yerr2./sk).^2);
            deno = err + 0.01 * err2;
            if (deno <= 0.0); deno = 1.0; end;
            error = abs(h)*err*sqrt(1.0/(obj.n*deno));
        end
    end

...
%for number = 1:2
    ...
    theta2 = computePhase(X2,ones(size(X2)),piezoSign2,'Period',period2); 
    % g2 estimation
    nG2 = 1;
    [g2values,nPhotons] = deal(zeros(nG2,1));
    for iG2=1:nG2
        [uniformX2,uniformTheta2] = seriesUniformSampling(X2(:),theta2(:),'NBins',100);
    ...
    for iG2=1:nG2
        [uniformX12,uniformTheta12] = seriesUniformSampling(X1(:)+X2(:),theta12(:),'NBins',100);
...
theta12 = mod(theta2 - theta1,2*pi); %Why 4pi?
histogram(theta12)
